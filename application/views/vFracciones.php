            ...
            <form id="frmNuevo">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        <input type="text" maxlength="15"  class="form-control form-control-sm numbersOnly" id="Clave" name="Clave" required >
                    </div>
                    <div class="col-sm">
                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <select class="form-control form-control-sm required"  name="DepartamentoCat" required=""> 
                            <option value=""></option>  
                        </select>
                    </div>
                    <div class="col-sm">
