    ...
    <div class="card border-0">
        ...
        <style type="text/css">
            ...
            .ring div {
                ...
                border-color: #64533b transparent #64533b transparent;
            ...
            .ring div:nth-child(2) {
                ...
                top: 30px;
                left: 30px;
                border-color: transparent #80a352 transparent #80a352;
                -webkit-animation: ring_reverse .5s linear infinite;
                animation: ring_reverse .5s linear infinite;
            }
            .ring {
